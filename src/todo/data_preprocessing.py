...
# 保存预处理后的数据
train_df.to_csv('/root/newstextclassification_new/data/train_set_processed.csv', sep='\t', index=False)
test_df.to_csv('/root/newstextclassification_new/data/test_a_processed.csv', sep='\t', index=False)

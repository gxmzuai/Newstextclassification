...
model.load_state_dict(torch.load("/root/autodl-tmp/02/bert_news_cls_epoch_30.pth"))
model.to(device)
model.eval()
...
submission.to_csv(
    "/root/newstextclassification_new/results/news_submission_30.csv", index=False
)
